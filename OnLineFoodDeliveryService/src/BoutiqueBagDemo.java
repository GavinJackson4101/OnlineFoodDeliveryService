...
// initialize the abstracted array and populate with Objects
        ...
        Clothes[0] = new ClothingItem("Black Shirt", 19.99);
        Clothes[1] = new ClothingItem("Orange Shirt", 29.99);
        Clothes[2] = new ClothingItem("Plaid Socks", 8.57);
        Clothes[3] = new ClothingItem("Tan Skirt", 79.99);
        Clothes[4] = new ClothingItem("White Wash Jeans", 59.39);
        Clothes[5] = new ClothingItem("Designer Jeans", 299.99);
